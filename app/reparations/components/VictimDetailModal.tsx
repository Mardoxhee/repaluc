  ...
  return (
    <>
      <Modal show={true} onClose={onClose} size="7xl">
        ...
        <div className="max-h-[80vh] overflow-y-auto pr-2 !bg-white !text-gray-900">
          <div className="flex flex-col md:flex-row gap-6 mb-6 p-4 !bg-white">
            <img
              src={avatar}
              alt="avatar"
            ...
            <div className="flex-1">
              <div className="flex gap-4 items-center mb-4">
                ...
                <span className="ml-auto text-base !text-gray-400 mt-10">{age} ans</span>
              </div>
          ...
          <div className="mt-6 p-4 !bg-white !text-gray-900">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="text-base font-bold !text-pink-700 mb-4 flex items-center">
                    <Info className="mr-2 !text-pink-700" size={16} /> Préjudices subis détaillés
                  </h4>
                  <div className="space-y-4">
                    {prejudicesSubis ? (
                      <div className="p-4 rounded-lg !border !border-gray-200 !bg-gray-50 flex flex-col md:flex-row md:items-center md:gap-6 shadow-sm">
